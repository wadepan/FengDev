...
using SCUSIdentityServerSQL;
using SCUSIdentityServerSQL.Pages.Admin.ApiScopes;
using SCUSIdentityServerSQL.Pages.Admin.Clients;
using SCUSIdentityServerSQL.Pages.Admin.IdentityScopes;
using Serilog;
    ...
    internal static class HostingExtensions
    {
        public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
        {
            ...
            // this adds the necessary config for the simple admin/config pages
            {
                ...
                builder.Services.AddTransient<SCUSIdentityServerSQL.Pages.Portal.ClientRepository>();
